    ...
    async function fetchData() {
      ...
      try {
        if (user) {
          ...
          setStats({
            balance: Number(me?.balance || 1042.5),
    ...
    <div className="min-h-screen bg-[var(--bg)] text-[var(--text)]">
      ...
      <div className="mx-auto grid max-w-[1200px] grid-cols-1 gap-8 border-b border-[var(--border)] px-4 pb-10 pt-12 md:gap-12 md:px-8 md:pb-12 md:pt-20 lg:grid-cols-[1fr_420px] lg:items-center">
        <div>
          ...
          <p className="mt-4 font-mono text-[0.6rem] tracking-[0.04em] text-[var(--text-muted)]">@cornell.edu required &middot; cumulative wallets &middot; BETA</p>
        </div>
